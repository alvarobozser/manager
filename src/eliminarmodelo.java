...
public class eliminarmodelo extends JFrame {
	...
	public void eliminarmodelo() {
		...
		String sql = "delete from modelos where ref=?";
		...
		try {
			...
			pst.executeUpdate();
			JOptionPane.showMessageDialog(null, "Modelo Eliminado con Exito");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					eliminarmodelo frame = new eliminarmodelo();
	...
	public eliminarmodelo() {
		...
		JButton modificar = new JButton("Eliminar");
		modificar.setIcon(new ImageIcon(eliminarmodelo.class.getResource("/imagenes/icons8-eliminar-16.png")));
		modificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				eliminarmodelo();
			}
		});
		modificar.setToolTipText("Eliminar");
